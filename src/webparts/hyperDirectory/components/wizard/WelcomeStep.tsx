...
import { DIRECTORY_WIZARD_CONFIG, buildStateFromProps } from "./directoryWizardConfig";
...
export interface IWelcomeStepProps {
  ...
  onApply: (result: Partial<IHyperDirectoryWebPartProps>) => void;
  /** Existing web part props for re-editing (undefined for first-time setup) */
  currentProps?: IHyperDirectoryWebPartProps;
}
