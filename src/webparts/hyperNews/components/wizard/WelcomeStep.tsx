...
import { NEWS_WIZARD_CONFIG, buildStateFromProps } from "./newsWizardConfig";
...
export interface IWelcomeStepProps {
  ...
  onApply: (result: Partial<IHyperNewsWebPartProps>) => void;
  /** Existing web part props for re-editing (undefined for first-time setup) */
  currentProps?: IHyperNewsWebPartProps;
}
