...
import styles from "./HyperNavGroupSection.module.scss";

export interface IHyperNavGroupSectionProps {
  groupName: string;
  linkCount: number;
  expanded: boolean;
  onToggle: () => void;
...
export const HyperNavGroupSection: React.FC<IHyperNavGroupSectionProps> = function (props) {
