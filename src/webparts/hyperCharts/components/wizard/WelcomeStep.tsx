...
import type { IHyperChartsWebPartProps } from "../../models";
import { CHARTS_WIZARD_CONFIG, buildStateFromProps } from "./chartsWizardConfig";
...
export interface IWelcomeStepProps {
  ...
  onApply: (result: Partial<IHyperChartsWebPartProps>) => void;
  /** Existing web part props for re-editing (undefined for first-time setup) */
  currentProps?: IHyperChartsWebPartProps;
}
