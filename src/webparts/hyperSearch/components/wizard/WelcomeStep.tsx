...
import { SEARCH_WIZARD_CONFIG, buildStateFromProps } from "./searchWizardConfig";
...
export interface IWelcomeStepProps {
  ...
  onApply: (result: Partial<IHyperSearchWebPartProps>) => void;
  /** Existing web part props for re-editing (undefined for first-time setup) */
  currentProps?: IHyperSearchWebPartProps;
}
