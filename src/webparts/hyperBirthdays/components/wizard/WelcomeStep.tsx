...
import { BIRTHDAYS_WIZARD_CONFIG, buildStateFromProps } from "./birthdaysWizardConfig";
...
export interface IWelcomeStepProps {
  ...
  onApply: (result: Partial<IHyperBirthdaysWebPartProps>) => void;
  /** Existing web part props for re-editing (undefined for first-time setup) */
  currentProps?: IHyperBirthdaysWebPartProps;
}
